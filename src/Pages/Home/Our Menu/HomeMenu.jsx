  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-12 mb-32">
        <Link to="/menu">
          <button className="hover:bg-transparent text-xl btn bg-transparent text-blue-950 font-inter font-medium  uppercase text-center border-b-2 border-blue-950">
            View Full Menu
          </button>
        </Link>
      </div>
